...
public class SmithWatermanB80 {
	...
	int[][] b80 = new int[25][25];
	
	public List<Integer> goalCell;
	public List<String> orderList80;

	public SmithWatermanB80(String s, String t) {
	...
	public void initializeb80() {

		try {
		BufferedReader br = new BufferedReader(new FileReader(new File("blosum80")));
		String order = br.readLine().trim();
		String[] symbols = order.split("\\s+");
		orderList80 = Arrays.asList(symbols);
		...
		while((str=br.readLine())!=null) {
			...
			for(int j=0; j<valueStrings.length; j++) {
				b80[i][j] = Integer.parseInt(valueStrings[j]);
			}
	...
	int match(char c, char d) {
		int i = orderList80.indexOf((c+"").toUpperCase());
		int j = orderList80.indexOf((d+"").toUpperCase());
	...
	public static void main(String[] arg) throws FileNotFoundException {
		...
		*/
		...
		// Find the similarity
		SmithWatermanB80 sw = new SmithWatermanB80(str1, str2);
		sw.doSmithWaterman();
